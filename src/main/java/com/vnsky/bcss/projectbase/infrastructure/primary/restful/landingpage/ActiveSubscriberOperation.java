package com.vnsky.bcss.projectbase.infrastructure.primary.restful.landingpage;
...
@Tag(name = "active-subscriber", description = "Apis for active subscriber")
@RequestMapping("${application.path.base.landing-page}/active-subscriber")
public interface ActiveSubscriberOperation {
