...
public class BookEsimFreeRest implements BookEsimFreeOperation {
    ...
    @Override
    public ResponseEntity<Page<SaleOrderDTO>> getBookEsimFree(Pageable pageable, String dateFrom, String dateTo, Integer status, String textSearch) {
        return ResponseEntity.ok(bookEsimServicePort.getListBookEsimFree(pageable));
    }
}
