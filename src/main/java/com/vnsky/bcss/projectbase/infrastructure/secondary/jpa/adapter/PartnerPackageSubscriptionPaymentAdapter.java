...
public class PartnerPackageSubscriptionPaymentAdapter extends BaseJPAAdapterVer2<
    ...
    @Override
    public Optional<PartnerPackageSubscriptionPaymentDTO> findBySubscriptionId(String subscriptionId) {
        return repository.findBySubscriptionId(subscriptionId).map(mapper::toDto);
    }
}
